...
Below is the current PT 2.0 Draft 2 Spec. You can also view this in [PDF form](https://github.com/OpenInternet/PT-website/blob/gh-pages/assets/PTSpecV2Draft2.pdf%20?raw=true). It may be useful to also reference the [history of the spec](/spec/history).
